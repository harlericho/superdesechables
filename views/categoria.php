...
<div class="wrapper">
          ...
          <div class="col-md-4">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                <h3 class="box-title">Formulario categorias</h3>
              </div>
              <!-- form start -->
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="descripcion" placeholder="Descripción categoria" autofocus required>
                    </div>
                  </div>
                </div>
                <!-- /.box-body -->
  ...
  <script src="../code/categoria.js"></script>