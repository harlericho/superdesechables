const app = new (function () {
  ...
  this.listado = () => {
    fetch("../controllers/factura/facturaListadoIGController.php", {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
        if (data.length > 0) {
          ...
          html += "<tr>";
          html +=
            "<th>Usuario facturado</th><th>Dni</th><th>Cliente(s)</th><th>Forma pago</th><th>Número factura</th><th>Fecha</th><th>Subtotal</th><th>Impuesto %</th><th>Total</th><th>Estado</th>";
          html += "</tr>";
          html += "</thead>";
          html += "<tbody>";
          ...
          this.facturasInactivas.innerHTML =
