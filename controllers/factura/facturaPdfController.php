...
$pdf->SetX(60);
$pdf->Cell(90, 5, Empresa::getDireccion(), 0, 1, 'L');
$pdf->SetX(60);
$pdf->Cell(90, 5, "Tel: " . Empresa::getTelefono(), 0, 1, 'L');
$pdf->SetX(60);
$pdf->Cell(90, 5, Empresa::getEmailClientes(), 0, 1, 'L');
...
$pdf->Cell(100, 6, "Email: $clienteEmail", 0, 1);
